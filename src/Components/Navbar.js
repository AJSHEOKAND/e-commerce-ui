...
const Navbar = () => {
    ...
    return (
        <div className="xl:p-8 p-2 xl:px-24 px-10 flex justify-between ">
            ...
            <div>
                {isMobile ? (
                    <div className={` flex flex-col ${toggleMenu ? "flex" : "hidden"} lg:hidden text-neutral-500  bg-slate-200   pl-6 absolute right-14  top-14  shadow-2xl `}>
                        ...
                        <ul>
                            ...
                            <li className="my-2 flex flex-row gap-1">Shop  <img src={Voctor} alt="Vector" /></li>
